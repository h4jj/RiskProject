...
int main()
{
    ...
    cout << "generate 5 cards and add them to hand" < < < endl for (int i = 0; i < 5; i++)
    {
        han1.setHandCards(deck1.draw());
    }
    //print size of deck
    ...
    cout << "The hand contains " < < < endl
                                           ...
                                           cout
                                           << "play the cards in hand and add them to played cards" < < <
        endl for (int i = 0; i < hand1.getCardsInHand()->size(); i++)
    {
        hand1.play(hand1.getCardsInHand()->at(i));
    }
    ...
    cout << "The hand now contains " < < < endl
                                               ...
                                               cout
                                               << "The cards that were played are " < < <
        endl
